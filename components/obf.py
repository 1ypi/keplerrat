...
def obfuscate_code():
    try:
        ...
        script_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "bot_with_token.py")
        ...
        # Obfuscate the code
        obfuscator = BlankOBF(code, output_path)
        
        print(f"✅ Obfuscation complete! Obfuscated file saved as: {output_path}")
